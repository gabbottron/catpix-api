/*
	This package was a fork from: https://github.com/appleboy/gin-jwt where I fixed a few
	problems in the version of the code available at the time. I think he added my fixes in
	to a later branch, but ultimately I wanted full control of this package because it deals
	with security, and, well.. I don't trust anyone ;). Ultimately took my branch
	and included it directly in the project as there was a dependency conflict with the
	version of jwt-go being pulled in by go.mod :/.
	My original fork is here: https://github.com/gabbottron/gin-jwt
*/
package jwt
